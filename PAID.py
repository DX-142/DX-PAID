...
└━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┘
      ┌━━━━━━━━━━━━━━━━━ N3OB ━━━━━━━━━━━━━━━━━━┑
               \033[1;97mCREATED BY   :  Ajmir Hossain            
               \033[1;91mFACEBOK      :  DX Ajmir Hossain           
               \033[1;97mGITHUB       :  DX-142    
               \033[1;91mSTATUS       :   PAID😴            
               \033[1;97mTEAM         :  ON TEAM               
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/DX-142/BCS_KING/blob/main/DX.txt').text
    if id in httpCaht:
      ...
      print('BKASH PERSONAL - +8801813225678)
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://www.youtube.com/@DX_Ajmir_142')
		crack_file()
...
def menu1():
	...
	ot = input('\n   \x1b[1;32m Choose option >>> ')
	if ot == '1':
		os.system('xdg-open https://facebook.com/groups/368728101298593/')
		crack_file()
	if ot == '2':
		os.system('xdg-open https://facebook.com/groups/368728101298593/')
		rndm()
